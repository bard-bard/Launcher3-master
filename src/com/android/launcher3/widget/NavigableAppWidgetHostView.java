...
public abstract class NavigableAppWidgetHostView extends AppWidgetHostView
    ...
    public int getDescendantFocusability() {
        //FOCUS_BEFORE_DESCENDANTS,自己先处理焦点，如果没有处理再分发给子view
        //FOCUS_BLOCK_DESCENDANTS，自己处理焦点，不分发给子view；
    ...
    public void requestChildFocus(View child, View focused) {
        ...
        //setFocusableInTouchMode这个方法如果设置为true，那么第一次点击是获取焦点，第二次点击才是响应点击事件。
        if (focused != null) {
    ...
    private void dispatchChildFocus(boolean childIsFocused) {
        ...
        //切换背景图，根据焦点是否在子view上，切换子view的状态
    ...
    private void updateTranslation() {
        //setx和setTranslationX的区别。setx减去了view相对于边界的距离，如margin = 20，setx（100），那么位移为80，setTranslationX（100），位移为100.
